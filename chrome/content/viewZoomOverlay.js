...
var ZoomManager = {
  ...
  setZoomForBrowser: function ZoomManager_setZoomForBrowser(aBrowser, aVal) {
    ...
    this.throwFullZoomChangedEvent();
  },

  throwFullZoomChangedEvent: function ZoomManager_throwFullZoomChangedEvent()
  {
    var event = getBrowser().contentDocument.createEvent("Events");
    event.initEvent("FullZoomChanged", true, true);
